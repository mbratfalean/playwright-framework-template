...
(0, test_1.test)("Sample Web Test", ({ page, browser }) => __awaiter(void 0, void 0, void 0, function* () {
    const browserContext = yield browser.newContext();
    const webHelper = new webHelper_1.WebHelper(page, browserContext);
}));
const TODO_ITEMS = [
    "buy some cheese",
    "feed the cat",
...
test_1.test.describe("New Todo", () => {
    (0, test_1.test)("should allow me to add todo items", ({ page }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_1.expect)(page.getByTestId("todo-title")).toHaveText([TODO_ITEMS[0]]);
        // Create 2nd todo.
...
test_1.test.describe("Editing", () => {
    ...
    (0, test_1.test)("should hide other controls when editing", ({ page }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_1.expect)(todoItem.getByRole("checkbox")).toBeHidden();
...
function checkNumberOfCompletedTodosInLocalStorage(page, expected) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield page.waitForFunction((e) => {
            return (JSON.parse(localStorage["react-todos"]).filter((i) => i.completed)
                .length === e);
        }, expected);
    });
}
